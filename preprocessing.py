...
'''
    ...
    edge_false_idx = list(range(len(edges_false))) #给所有的边一个编号，从0到n
    np.random.shuffle(edge_false_idx)#给所有的边打散
    #edges_neg = edges_false[edge_nfalse_idx[:l]]
    for i in  range(200):
        edges_neg.append(edges_false[edge_false_idx[i]])
'''
